...
\ac{NFC}, ist eine auf R\+F\+ID (\char`\"{}radio-\/frequency identification\char`\"{}) basierende Technologie zur kontaktlosen Datenübertragung. \\
...
\begin{acronym}
	...
	\acro{APDU}{Application Protocol Data Unit: Anwendungseinheit innerhalb der NFC-Kommunikation}
